...
<head>
    ...
    <style>
        body { background: #f4f6f8; font-family: 'Segoe UI', sans-serif; display: flex; flex-direction: column; min-height: 100vh; }
        .main-container { flex: 1; }
        .card-header-ceb { background: #343a40; color: white; padding: 20px; text-align: center; border-radius: 10px 10px 0 0 !important; }
        .form-control:focus, .form-select:focus { border-color: #343a40; box-shadow: 0 0 5px rgba(52,58,64,0.3); }
        .footer { background: #343a40; color: white; padding: 15px 0; text-align: center; margin-top: auto; }
    </style>
</head>
<body>
                ...
                <div class="card shadow border-0 rounded-3">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        if(isset($_POST['submit_mc'])) {
                            $j = trim($_POST['job_no']); $a = trim($_POST['acc_no']); $om = trim($_POST['old_met']); $p = $_POST['phase'];
    ...
    <footer class="footer"><div class="container small">&copy; <?php echo date('Y'); ?> CEB Services.</div></footer>
