...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3"><div class="card shadow-sm border-0 border-bottom border-4 border-primary h-100 p-3"><div class="d-flex justify-content-between align-items-center"><div><h6 class="text-secondary small fw-bold mb-1">REMOVED</h6><h2 class="fw-bold text-dark mb-0"><?php echo $mj_rem; ?></h2></div><div class="bg-primary bg-opacity-10 p-3 rounded-circle"><i class="fas fa-screwdriver fa-2x text-primary"></i></div></div></div></div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4"><div class="card shadow-sm border-0 border-start border-4 border-dark h-100 p-3"><div class="d-flex justify-content-between align-items-center"><div><h6 class="text-secondary small fw-bold mb-1">TOTAL REQUESTS</h6><h2 class="fw-bold text-dark mb-0"><?php echo $mc_all; ?></h2></div><div class="bg-dark bg-opacity-10 p-3 rounded-circle"><i class="fas fa-folder-open fa-2x text-dark"></i></div></div></div></div>
        <div class="col-md-4"><div class="card shadow-sm border-0 border-start border-4 border-warning h-100 p-3"><div class="d-flex justify-content-between align-items-center"><div><h6 class="text-secondary small fw-bold mb-1">PENDING CHANGE</h6><h2 class="fw-bold text-warning mb-0"><?php echo $mc_pend; ?></h2></div><div class="bg-warning bg-opacity-10 p-3 rounded-circle"><i class="fas fa-clock fa-2x text-warning"></i></div></div></div></div>
        <div class="col-md-4"><div class="card shadow-sm border-0 border-start border-4 border-success h-100 p-3"><div class="d-flex justify-content-between align-items-center"><div><h6 class="text-secondary small fw-bold mb-1">COMPLETED CHANGE</h6><h2 class="fw-bold text-success mb-0"><?php echo $mc_comp; ?></h2></div><div class="bg-success bg-opacity-10 p-3 rounded-circle"><i class="fas fa-check-double fa-2x text-success"></i></div></div></div></div>
    </div>
    ...
    <i class="fas fa-chart-area text-secondary me-2"></i> Weekly Job Intake (Removal vs Change)</div>
                <div class="card-body">
...
<script>
    ...
    new Chart(ctx, {
        ...
        options: { 
            responsive: true, 
            plugins: { 
                legend: { display: true, position: 'top' } // Legend එක පෙන්නන්න
            }, 
            scales: { 
