...
?>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3"><div class="card shadow-sm border-start border-4 border-warning h-100 p-2"><div class="card-body p-1"><h6 class="text-secondary small fw-bold">TOTAL JOBS</h6><h2 class="fw-bold text-dark mb-0"><?php echo $mj_pend; ?></h2><small class="text-muted" style="font-size:10px">Total Cards</small></div></div></div>
        <div class="col-md-3"><div class="card shadow-sm border-start border-4 border-primary h-100 p-2"><div class="card-body p-1"><h6 class="text-secondary small fw-bold">REMOVED</h6><h2 class="fw-bold text-dark mb-0"><?php echo $mj_rem; ?></h2><small class="text-muted" style="font-size:10px">Unique Accs</small></div></div></div>
